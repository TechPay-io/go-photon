...
import (
	...
	base "github.com/TechPay-io/sirius-base/eventcheck/epochcheck"
...
type Reader interface {
	base.Reader
	GetEpochRules() (photon.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules photon.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules photon.Rules) error {
...
func CheckTxs(txs types.Transactions, rules photon.Rules) error {
	maxType := uint8(0)
