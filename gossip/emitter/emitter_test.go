...
import (
	...
	"github.com/TechPay-io/go-photon/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/TechPay-io/go-photon/gossip/emitter External,TxPool,TxSigner,Signer
