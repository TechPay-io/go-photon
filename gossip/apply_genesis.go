...
import (
	...
	"github.com/TechPay-io/go-photon/gossip/evmstore"
	"github.com/TechPay-io/go-photon/gossip/sfcapi"
...
func (s *Store) applyEpoch0Genesis(g photon.Genesis) (evmBlock *evmcore.EvmBlock, err error) {
...
func (s *Store) applyEpoch1Genesis(blockProc BlockProc, g photon.Genesis) (err error) {
	...
	prettyHash := func(root common.Hash, g photon.Genesis) hash.Event {
