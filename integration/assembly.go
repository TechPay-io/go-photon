...
import (
	...
	"github.com/TechPay-io/go-photon/utils/adapters/vecmt2dagidx"
...
func rawApplyGenesis(gdb *gossip.Store, cdb *abft.Store, g photon.Genesis, cfg Configs) error {
	_, _, _, err := rawMakeEngine(gdb, cdb, g, cfg, true)
	return err
}

func rawMakeEngine(gdb *gossip.Store, cdb *abft.Store, g photon.Genesis, cfg Configs, applyGenesis bool) (*abft.Sirius, *vecmt.Index, gossip.BlockProc, error) {
