...
import (
	...
	"github.com/TechPay-io/go-photon/inter/drivertype"
	...
	"github.com/TechPay-io/go-photon/photon/genesis/driver/drivercall"
	"github.com/TechPay-io/go-photon/photon/genesis/driver/driverpos"
	...
	netinitcall "github.com/TechPay-io/go-photon/photon/genesis/netinit/netinitcalls"
...
func NewDriverTxGenesisTransactor(g photon.Genesis) *DriverTxGenesisTransactor {
...
func (p *DriverTxListener) OnNewLog(l *types.Log) {
	...
	if l.Topics[0] == driverpos.Topics.UpdateNetworkRules && len(l.Data) >= 64 {
		...
		p.bs.DirtyRules, err = photon.UpdateRules(p.bs.DirtyRules, diff)
		if err != nil {
