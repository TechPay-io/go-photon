...
import (
	...
	"github.com/TechPay-io/go-photon/cmd/photon/launcher/metrics"
	"github.com/TechPay-io/go-photon/cmd/photon/launcher/tracing"
	"github.com/TechPay-io/go-photon/debug"
	"github.com/TechPay-io/go-photon/flags"
	"github.com/TechPay-io/go-photon/gossip"
	"github.com/TechPay-io/go-photon/integration"
	"github.com/TechPay-io/go-photon/utils/errlock"
	"github.com/TechPay-io/go-photon/valkeystore"
	_ "github.com/TechPay-io/go-photon/version"
)

const (
	// clientIdentifier to advertise over the network.
	clientIdentifier = "go-photon"
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the go-photon command line interface")
...
// photon is the main entry point into the system if no special subcommand is ran.
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	// Create a client to interact with local photon node.
	...
	if ctx.GlobalBool(utils.ExitWhenSyncedFlag.Name) {
		go func() {
			for first := true; ; first = false {
				// Call tpc_syncing until it returns false
				time.Sleep(5 * time.Second)

				var syncing bool
				err := rpcClient.CallContext(context.TODO(), &syncing, "tpc_syncing")
				if err != nil {
					continue
				}
				if !syncing {
