Please check if what you want to add to `go-photon` list meets [quality standards](https://github.com/TechPay-io/go-photon/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
